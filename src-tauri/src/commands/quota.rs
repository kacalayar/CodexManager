...
async fn refresh_antigravity_token(client: &reqwest::Client, refresh_token: &str) -> Result<String, String> {
    ...
    let client_id = ["1071006060591-tmhssin2h21lcre235vtolojh4g403", "ep.apps.googleusercontent.com"].concat();
    ...
    for cred in credentials {
        ...
        handles.push(tokio::spawn(async move {
            ...
            let mut headers = vec![
                ...
                ("User-Agent", "CodexManager".to_string()),
            ];
...
async fn fetch_copilot_quota_with_token(token: &str, login: &str) -> crate::types::CopilotQuotaResult {
    ...
    let headers = vec![
        ...
        ("Accept", "application/json".to_string()),
        ("User-Agent", "CodexManager/1.0".to_string()),
