...
// ============================================
// GitHub Copilot Multi-Instance Types
// ============================================

// Unique identifier for a Copilot instance
export type CopilotInstanceId = string;

// Configuration for a single Copilot instance
export interface CopilotInstanceConfig {
  accountType: string; // "individual", "business", "enterprise"
  enabled: boolean;
  githubToken: string;
  githubUsername: string; // Populated after authentication
  id: CopilotInstanceId;
...
export interface CopilotInstanceStatus {
...
// Map of all Copilot instance statuses
export interface CopilotStatusMap {
  instances: Record<CopilotInstanceId, CopilotInstanceStatus>;
  statuses?: Record<CopilotInstanceId, CopilotInstanceStatus>;
}

// GitHub Copilot configuration (via copilot-api)
// LEGACY: This is kept for backwards compatibility
// New code should use CopilotInstanceConfig[]
export interface CopilotConfig {
  instances: CopilotInstanceConfig[];
}
...
export function isCopilotModel(
  model: Pick<AvailableModel, "id" | "source"> & { ownedBy?: string },
): boolean {
