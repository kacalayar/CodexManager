...
export function SshSettings(props: SshSettingsProps) {
  ...
  const [sshRemote, setSshRemote] = createSignal(8320);
  const [sshLocal, setSshLocal] = createSignal(8320);
  ...
  return (
    <div class="space-y-4">
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400">
        Securely tunnel your local API (port 8320) to a remote server for shared access.
      </p>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div class="space-y-1">
            ...
            <input
              ...
              value={sshLocal()}
            />
            <p class="text-[10px] text-gray-400">Port running locally (default 8320)</p>
          </div>
        </div>
        <div class="pt-2">
          <Button
