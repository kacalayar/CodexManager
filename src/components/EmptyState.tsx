...
export function NoProvidersEmptyState(props: { onConnect: () => void }) {
  return (
    <EmptyState
      ...
      description="Connect your AI accounts to start using CodexManager with your favorite coding tools."
      icon={
        ...
        <div class="flex items-start gap-3 sm:gap-4">
          ...
          <div class="min-w-0 flex-1">
            ...
            <p class="text-sm text-green-700 dark:text-green-300">
              CodexManager is configured and ready. Start using your AI tools - all requests will be
        ...
        <div class="min-w-0 flex-1">
          <div class="mb-1 flex items-center justify-between">
            <h3 class="font-semibold text-gray-900 dark:text-gray-100">
              {completedSteps() === 0 ? "Welcome to CodexManager!" : "Almost there!"}
            </h3>
